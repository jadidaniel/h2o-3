...
# problem with merge.
test <- function() {
    # both frame with duplicate keys, merge provided wrong results.
    browser()
    h2o.removeAll()
    ...
    resultF <- as.h2o(data.frame(fruit=c(0,2,3,3,3,3,3,3,3,3,3,3,3,3,4,7,9,256,257,518,518,518,518,1028,1028,1028,1028), 
                                 color=c('blue','red','orange','orange','orange','orange','yellow','yellow','yellow',
                                         'yellow','red','red','red','red','purple','cyan','red','yellow','orange',
                                         'red','red','blue','blue','negra','negra','negra','negra'),
                                 citrus=c(NA,NA,TRUE,TRUE,FALSE,FALSE,TRUE,TRUE,FALSE,FALSE,TRUE,TRUE,FALSE,FALSE,
                                          NA,NA,NA,NA,NA,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE)))
    assertMergeCorrect(merged, resultF)
    ...
    browser()
    assertMergeCorrect(merged2, resultF)
